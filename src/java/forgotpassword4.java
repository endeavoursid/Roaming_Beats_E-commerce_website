...
public class forgotpassword4 extends HttpServlet
{
       ...
       try
        {
            ...
            String s1=(String)ses.getAttribute("em1");
           String q1="update t80 set epass='"+np+"' where eemail='"+s1+"'";
            int x=stmt.executeUpdate(q1);
            if(x>0)
            {
                pw1.println("<html>\n" +
"    <head>\n" +
"        <title>forgot password - Roaming beats</title>\n" +
"        <meta charset=\"UTF-8\">\n" +
...
"                               <span>Sign Up</span>\n" +
"                           </div>\n" +
"                           <h3>Password Changed Successfully...!</h3><br><br><br>\n" +
"                           <h3>Go back to\n" +
"                           </h3>\n" +
"                           <a href=\"login.jsp\"><button type=\"submit\" class=\"btn\">Login Page</button></a>\n" +
"                       </div>\n" +
"                   </div>\n" +
"               </div>\n" +
"           </div>\n" +
